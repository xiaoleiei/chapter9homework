...
//import static com.bytedance.ies.camerarecorddemoapp.YUV2RGBUtil.R;
...
public class MainActivity extends Activity {
    ...
    private ViewGroup.LayoutParams para;//新增
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FaceDetectHelper.getHelper().setFaceDetectedCallback(new FaceDetectHelper.OnFaceDetectedCallback() {
            @Override
            public void onFaceDetected(final int ret, final int top, final int bottom, final int left,final
            int right) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                     ...
                     //   imgv.setVisibility(View.INVISIBLE);
                       ...
                       // imgv.setLayoutParams(left);
                      //  imgv.setImageResource(R.drawable.);

                       //// imgv.setAlpha(0);

                       // imgv.setMaxHeight(top);
                      //  Log.i(TAG, "run: top is state");

//                        para = imgv.getLayoutParams();
//                        para.height =bottom-top;
//                        para.width =right-left ;
